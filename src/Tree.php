...
class Tree
{
    ...
    /**
     * @var array $dependenciesPosList List of position in the tree for each dependency
     */
    protected $dependenciesPosList = [];
    ...
    public function generateTree()
    {
        ...
        foreach ($this->dependenciesInfos as $name => $dependency) {
            ...
            $this->dependenciesPosList[$name] = [$order];
        }
    ...
    protected function checkDepend($dependencyName)
    {
        ...
        foreach ($listDepends as $dependencyName) {
            $dependencyPos   = $this->dependenciesPosList[$dependencyName];
